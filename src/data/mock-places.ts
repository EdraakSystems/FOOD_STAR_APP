...
export const mockPlaceDetails: Place = {
  ...
  coverImage: require('../assets/common/img1.jpg'),
  image: require('../assets/common/img1.jpg'),
    ...
    },
    {
      ...
      data: Array(4)
        ...
        .map((_) => ({
          ...
          description: faker.lorem.lines(2),
          price: faker.commerce.price(5, 60),
          image: require('@src/assets/dish-details/pasta.jpg'),
        })),
    },
    {
      title: 'Dessert',
      data: Array(6)
        ...
        .map((_) => ({
          ...
          description: faker.lorem.lines(2),
          price: faker.commerce.price(5, 60),
          image: require('@src/assets/dish-details/dessert.jpg'),
        })),
    },
  ],
};
...
export const mockRemarkablePlace: RemarkablePlaceTab = {
  featured: [
    ...
    },
    {
      ...
      image: require('../assets/common/img2.jpg'),
    ...
    },
    {
      ...
      image: require('../assets/common/img3.jpg'),
    ...
    },
    {
      ...
      image: require('../assets/common/img4.jpg'),
      subTitle: 'Western, Spaghetti',
      distance: 75,
      time: 90,
      rating: 4,
    },
    {
      ...
      image: require('../assets/common/img5.jpg'),
      subTitle: 'Eastern, BanhMi, Breads',
      distance: 91,
      time: 64,
      rating: 5,
